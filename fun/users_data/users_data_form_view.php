...
<div class="container">
	...
	<form class="form-horizontal" action="index.php" method="POST" enctype="multipart/form-data">
		...
		<input readonly="" type="hidden" class="form-control input-sm" id="" placeholder="" name="id_user" value="<?php if(isset($_SESSION['id_user'])) echo $_SESSION['id_user']?>">
		<input readonly="" type="hidden" class="form-control input-sm" id="" placeholder="" name="login" value="<?php if(isset($values['login'])) echo $values['login']?>">
				...
				<div class="col-sm-6 col-sm-offset-6">
					...
					<label for="image">Seleccione una imagen de perfil</label>	
						<div class="input-group">
							...
							<img src="<?php echo full_url?>/web/files/usuarios/<?php echo $values['image'];?>" height="80">
							<?php endif;?>
			...
			<!--<a class="btn btn-default"  href="<?php echo full_url."/fun/index.php?action=bienvenida"?>"><i class="fa fa-arrow-left  fa-pull-left fa-border"></i> Cancelar</a>-->
